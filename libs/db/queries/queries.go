...
const (
	...
	CacheCube = `
		INSERT INTO semantic_cube_cache (tenant_id, cube_name, metadata, dimensions, measures, pre_aggregations, cached_at)
	...
	InvalidateCubeCache = `DELETE FROM semantic_cube_cache WHERE tenant_id = $1 AND cube_name = $2`
