...
CREATE MATERIALIZED VIEW LOG ON interest_income WITH ROWID; CREATE MATERIALIZED VIEW mv_nim REFRESH FAST AS SELECT * FROM net_interest_margin;

-- Performance Notes: Use materialized view logs for incremental refresh
