...
type CustomerServiceInterface interface {
	List(ctx context.Context, tenantID uuid.UUID, subtypeCode string) ([]CustomerRecord, error)
	Get(ctx context.Context, tenantID, id uuid.UUID) (*CustomerRecord, error)
	Create(ctx context.Context, tenantID uuid.UUID, rec *CustomerRecord) error
...
func NewHandlerWithService(svc CustomerServiceInterface) *Handler {
	return &Handler{svc: svc}
}

func (h *Handler) RegisterRoutes(r chi.Router) {
	r.Route("/api/master/customers", func(r chi.Router) {
		r.Get("/", h.List)
		r.Get("/{id}", h.Get)
		r.Post("/", h.Create)
