...
package org_isda_cdm
   ...
   */
  DividendDateReferenceEnum_AD_HOC_DATE DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CASH_SETTLE_PAYMENT_DATE_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CASH_SETTLE_PAYMENT_DATE_ISSUER_PAYMENT DividendDateReferenceEnum = iota + 1
  /**
   * If 'Dividend Payment Date(s)' is specified in the Transaction Supplement as 'Cash Settlement Payment Date', then the Dividend Payment Date in respect of a Dividend Amount shall be the Cash Settlement Payment Date relating to the end of the Dividend Period during which the Shares commenced trading 'ex' the relevant dividend on the Exchange.
   */
  DividendDateReferenceEnum_CASH_SETTLEMENT_PAYMENT_DATE DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_EQUITY_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_EQUITY_EX_DIV_BEFORE_RESET DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_EQUITY_PAID DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_EQUITY_PAID_BEFORE_RESET DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_EQUITY_PAID_INCL_RESET DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_INTEREST_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_INTEREST_PAID DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_INTEREST_PAID_BEFORE_RESET DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_CUMULATIVE_INTEREST_PAID_INCL_RESET DividendDateReferenceEnum = iota + 1
  /**
   * Date on which the dividend will be paid by the issuer.
   */
  DividendDateReferenceEnum_DIVIDEND_PAYMENT_DATE DividendDateReferenceEnum = iota + 1
  /**
   * In respect of each Dividend Period, the relevant Dividend Valuation Date.
   */
  DividendDateReferenceEnum_DIVIDEND_VALUATION_DATE DividendDateReferenceEnum = iota + 1
  /**
   * Equity payment date of the swap.
   */
  DividendDateReferenceEnum_EQUITY_PAYMENT_DATE DividendDateReferenceEnum = iota + 1
  /**
   * Date on which a holder of the security is entitled to the dividend.
   */
  DividendDateReferenceEnum_EX_DATE DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_FLOATING_AMOUNT_PAYMENT_DATE DividendDateReferenceEnum = iota + 1
  /**
   * The next payment date of the swap.
   */
  DividendDateReferenceEnum_FOLLOWING_PAYMENT_DATE DividendDateReferenceEnum = iota + 1
  /**
   * Date on which the dividend will be recorded in the books of the paying agent.
   */
  DividendDateReferenceEnum_RECORD_DATE DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_SHARE_PAYMENT DividendDateReferenceEnum = iota + 1
  /**
   * Termination date of the swap.
   */
  DividendDateReferenceEnum_TERMINATION_DATE DividendDateReferenceEnum = iota + 1
  /**
   * Trade date of the swap
   */
  DividendDateReferenceEnum_TRADE_DATE DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_OR_EQUITY_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_OR_EQUITY_PAID DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_OR_INTEREST_EX_DIV DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_OR_INTEREST_PAID DividendDateReferenceEnum = iota + 1
  /**
   ...
   */
  DividendDateReferenceEnum_UNWIND_PAID DividendDateReferenceEnum = iota + 1
  )    
