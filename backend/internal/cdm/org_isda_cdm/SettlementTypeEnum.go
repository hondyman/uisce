...
package org_isda_cdm
   ...
   */
  SettlementTypeEnum_CASH SettlementTypeEnum = iota + 1
  /**
   * Allow use of either Cash or Physical settlement without prior Election.
   */
  SettlementTypeEnum_CASH_OR_PHYSICAL SettlementTypeEnum = iota + 1
  /**
   * Allow Election of either Cash or Physical settlement.
   */
  SettlementTypeEnum_ELECTION SettlementTypeEnum = iota + 1
  /**
   ...
   */
  SettlementTypeEnum_PHYSICAL SettlementTypeEnum = iota + 1
  )    
