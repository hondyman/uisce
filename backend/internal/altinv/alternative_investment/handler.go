...
type AlternativeInvestmentServiceInterface interface {
	List(ctx context.Context, tenantID uuid.UUID, subtypeCode string) ([]AlternativeInvestmentRecord, error)
	Get(ctx context.Context, tenantID, id uuid.UUID) (*AlternativeInvestmentRecord, error)
	Create(ctx context.Context, tenantID uuid.UUID, rec *AlternativeInvestmentRecord) error
	SoftDelete(ctx context.Context, tenantID, id uuid.UUID) error
}

type Handler struct {
	svc AlternativeInvestmentServiceInterface
}
...
func NewHandlerWithService(svc AlternativeInvestmentServiceInterface) *Handler {
