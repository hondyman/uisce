...
var securityVocabulary = map[string][]string{
	...
	"security_ca_linkage":            terms("ID SecurityIdentifier CorporateActionID LinkageType SourceSystemIdentifier Confidence IsPrimary Status CustomAttributes CreatedAt UpdatedAt TenantId"),
	"security_change_request":        terms("ID RequestReference SecurityIdentifier AssetClassCode ChangeType RequestedChanges RequestReason Source Status RequestedBy AssignedTo ApprovedBy ApprovedAt AppliedAt RejectionReason CustomAttributes CreatedAt UpdatedAt TenantId"),
	"security_exception":             terms("ID SecurityIdentifier IdentifierValue AssetClassCode ExceptionType Severity ExceptionDescription SourceSystemIdentifier DetectedAt Status AssignedTo ResolvedAt ResolutionNote CustomAttributes TenantId"),
	...
	"security_golden_record":         terms("ID SecurityIdentifier GoldenVersion IsCurrent AssetClassCode SecTypCd SecSubTypeCode EffectiveDate KnowledgeTimestamp GoldenAttributes WinningSources OverallDqScore IdentityConfidence Status PublishedAt PublishedBy TenantId"),
	...
	"security_identifier_conflict":   terms("ID IdentifierType IdentifierValue SourceSystemIdentifierA SourceValueA SourceSystemIdentifierB SourceValueB SecurityIdentifierA SecurityIdentifierB ConflictType Severity Status ResolutionNote ResolvedBy ResolvedAt CustomAttributes CreatedAt UpdatedAt TenantId"),
	"security_identifier_issuance":   terms("ID SecurityIdentifier IdentifierType IdentifierValue IssuingAuthority SourceSystemIdentifier FirstSeenAt LastConfirmedAt IsValid ValidationMethod CustomAttributes CreatedAt TenantId"),
	"security_match_candidate":       terms("ID MatchRuleId SecurityIdentifierA SecurityIdentifierB OverallScore DeterministicMatch MatchedKeys ConflictingKeys Status ReviewedBy ReviewedAt ReviewNote CustomAttributes CreatedAt UpdatedAt TenantId"),
	...
	"security_reconciliation_result": terms("ID ReconciliationId SecurityIdentifier IdentifierValue FieldName ValueA ValueB ValuesMatch VariancePercent Severity Status ResolvedBy ResolvedAt ResolutionNote TenantId"),
	...
	"security_term_sheet":            terms("ID SecurityIdentifier DocumentType DocumentName DocumentUrl DocumentHash Language EffectiveDate ExtractionStatus ExtractedAt ExtractedBy ReviewedBy ReviewedAt Confidence CustomAttributes CreatedAt UpdatedAt TenantId"),
