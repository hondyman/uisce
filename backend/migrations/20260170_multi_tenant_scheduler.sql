...
CREATE INDEX IF NOT EXISTS idx_scheduled_jobs_scope ON scheduled_jobs(scope);
CREATE INDEX IF NOT EXISTS idx_scheduled_jobs_parent ON scheduled_jobs(parent_job_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_scheduled_jobs_global_name_unique ON scheduled_jobs(name) WHERE scope = 'GLOBAL';
...
CREATE INDEX IF NOT EXISTS idx_scheduled_dags_scope ON scheduled_dags(scope);
CREATE INDEX IF NOT EXISTS idx_scheduled_dags_parent ON scheduled_dags(parent_dag_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_scheduled_dags_global_name_unique ON scheduled_dags(name) WHERE scope = 'GLOBAL';
