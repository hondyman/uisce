...
export function AppRoutes() {
  // Descendant <Routes> rendered inside LocaleShell's `/:locale/*` match.
  // The un-prefixed top-level routes (login, auth/callback, /api-studio, etc.)
  // are mounted directly in LocaleShell alongside the splat.
  return (
    <Routes>
