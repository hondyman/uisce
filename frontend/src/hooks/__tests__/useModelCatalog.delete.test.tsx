...
const MOCK_MODELS = [
  { id: 'uuid-1', model_key: 'core_model', display_name: 'Core Model', is_custom: false } as any,
  { id: 'uuid-2', model_key: 'core_model_custom', display_name: 'Custom Model', is_custom: true } as any,
];
