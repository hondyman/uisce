      ...
      {groupDefinitions.map((group) => (
        <Box key={group.id} sx={{ mb: 2, p: 2, border: '1px solid #e5e7eb', borderRadius: 1, position: 'relative', backgroundColor: '#fafafa' }}>
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ 'xs': 12, 'sm': 4 }}><TextField fullWidth size="small" label="Expression" helperText="Example: =Fields!Region" value={group.expression} onChange={(e) => onGroupChange(group.id, 'expression', e.target.value)} /></Grid>
