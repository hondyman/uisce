...
interface SimpleTableAutocompleteProps {
  datasourceId?: string;
...
const SimpleTableAutocomplete: React.FC<SimpleTableAutocompleteProps> = ({
  datasourceId,
  value,
  onChange,
  returnType = 'object',
  ...
  return (
    <Autocomplete
      ...
      freeSolo
  disablePortal={false}
  onOpen={() => devDebug('SimpleTableAutocomplete opened')}
  onClose={() => devDebug('SimpleTableAutocomplete closed')}
      onFocus={() => {
...
export default SimpleTableAutocomplete;
