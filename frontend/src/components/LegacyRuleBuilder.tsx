...
import type { ValidationRule as SharedValidationRule } from './validation/types';
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {availableRules.length > 0 && (
          <div className="mt-4">
            <label htmlFor="add-dependent-rule" className="sr-only">
              Add dependent rule
            </label>
            <select
              id="add-dependent-rule"
              ...
              onChange={(e: React.ChangeEvent<HTMLSelectElement>) => {
                ...
                // reset the controlled value back to the placeholder
                setAddValue('');
              }}
...
const CrossEntityValidationBuilder: React.FC<{
  sourceEntity: string;
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        <div className="bg-white rounded-lg shadow p-6">
          <h1 className="text-2xl font-bold text-gray-900 mb-2">
            Advanced Rule Configuration ddddd
          </h1>
