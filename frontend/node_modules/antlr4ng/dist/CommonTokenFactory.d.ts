...
export declare class CommonTokenFactory implements TokenFactory<CommonToken> {
    ...
    create(source: [TokenSource | null, CharStream | null], type: number, text: string | null, channel: number, start: number, stop: number, line: number, column: number): CommonToken;
}
