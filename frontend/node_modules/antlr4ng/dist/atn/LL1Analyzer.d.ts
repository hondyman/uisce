...
export declare class LL1Analyzer {
     ...
     */
    getDecisionLookahead(s: ATNState | null): Array<IntervalSet | null> | null;
    /**
     ...
     * is {@code null}.
     */
    _LOOK(s: ATNState, stopState: ATNState | null, ctx: PredictionContext | null, look: IntervalSet, lookBusy: HashSet<ATNConfig>, calledRuleStack: BitSet, seeThruPreds: boolean, addEOF: boolean): void;
}
