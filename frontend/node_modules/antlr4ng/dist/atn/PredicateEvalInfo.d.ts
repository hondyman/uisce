...
export declare class PredicateEvalInfo extends DecisionEventInfo {
     ...
     */
    constructor(decision: number, input: TokenStream, startIndex: number, stopIndex: number, semctx: SemanticContext, evalResult: boolean, predictedAlt: number, fullCtx: boolean);
}
