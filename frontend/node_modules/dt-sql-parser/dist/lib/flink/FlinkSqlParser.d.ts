...
export declare class FlinkSqlParser extends SQLParserBase {
    ...
    static readonly RULE_showStatement = 12;
    static readonly RULE_loadStatement = 13;
    static readonly RULE_unloadStatement = 14;
    static readonly RULE_setStatement = 15;
    static readonly RULE_resetStatement = 16;
    static readonly RULE_jarStatement = 17;
    ...
    static readonly RULE_columnNamePath = 27;
    static readonly RULE_columnNameList = 28;
    static readonly RULE_columnType = 29;
    static readonly RULE_lengthOneDimension = 30;
    static readonly RULE_lengthTwoOptionalDimension = 31;
    static readonly RULE_lengthTwoStringDimension = 32;
    static readonly RULE_lengthOneTypeDimension = 33;
    static readonly RULE_mapTypeDimension = 34;
    static readonly RULE_rowTypeDimension = 35;
    static readonly RULE_columnConstraint = 36;
    ...
    static readonly RULE_alterView = 64;
    ...
    static readonly RULE_valuesClause = 80;
    ...
    static readonly RULE_windowTVFClause = 95;
    static readonly RULE_windowTVFExpression = 96;
    static readonly RULE_windowTVFName = 97;
    ...
    static readonly RULE_groupingSetsNotationName = 106;
    ...
    static readonly RULE_orderItemDefinition = 116;
    ...
    static readonly RULE_functionCallExpression = 134;
    static readonly RULE_primaryExpression = 135;
    static readonly RULE_functionNameCreate = 136;
    static readonly RULE_functionName = 137;
    static readonly RULE_functionNameAndParams = 138;
    static readonly RULE_functionNameWithParams = 139;
    static readonly RULE_functionParam = 140;
    static readonly RULE_dereferenceDefinition = 141;
    static readonly RULE_correlationName = 142;
    static readonly RULE_qualifiedName = 143;
    static readonly RULE_timeIntervalExpression = 144;
    static readonly RULE_errorCapturingMultiUnitsInterval = 145;
    static readonly RULE_multiUnitsInterval = 146;
    static readonly RULE_errorCapturingUnitToUnitInterval = 147;
    static readonly RULE_unitToUnitInterval = 148;
    static readonly RULE_intervalValue = 149;
    static readonly RULE_tableAlias = 150;
    static readonly RULE_errorCapturingIdentifier = 151;
    static readonly RULE_errorCapturingIdentifierExtra = 152;
    static readonly RULE_identifierList = 153;
    static readonly RULE_identifierSeq = 154;
    static readonly RULE_identifier = 155;
    static readonly RULE_unquotedIdentifier = 156;
    static readonly RULE_quotedIdentifier = 157;
    static readonly RULE_whenClause = 158;
    static readonly RULE_catalogPath = 159;
    static readonly RULE_catalogPathCreate = 160;
    static readonly RULE_databasePath = 161;
    static readonly RULE_databasePathCreate = 162;
    static readonly RULE_tablePathCreate = 163;
    static readonly RULE_tablePath = 164;
    static readonly RULE_viewPath = 165;
    static readonly RULE_viewPathCreate = 166;
    static readonly RULE_uid = 167;
    static readonly RULE_withOption = 168;
    static readonly RULE_ifNotExists = 169;
    static readonly RULE_ifExists = 170;
    static readonly RULE_tablePropertyList = 171;
    static readonly RULE_tableProperty = 172;
    static readonly RULE_tablePropertyKey = 173;
    static readonly RULE_tablePropertyValue = 174;
    static readonly RULE_logicalOperator = 175;
    static readonly RULE_comparisonOperator = 176;
    static readonly RULE_bitOperator = 177;
    static readonly RULE_mathOperator = 178;
    static readonly RULE_unaryOperator = 179;
    static readonly RULE_constant = 180;
    static readonly RULE_timePointLiteral = 181;
    static readonly RULE_stringLiteral = 182;
    static readonly RULE_decimalLiteral = 183;
    static readonly RULE_booleanLiteral = 184;
    static readonly RULE_setQuantifier = 185;
    static readonly RULE_timePointUnit = 186;
    static readonly RULE_timeIntervalUnit = 187;
    static readonly RULE_reservedKeywordsUsedAsFuncParam = 188;
    static readonly RULE_reservedKeywordsNoParamsUsedAsFuncName = 189;
    static readonly RULE_reservedKeywordsFollowParamsUsedAsFuncName = 190;
    static readonly RULE_reservedKeywordsUsedAsFuncName = 191;
    static readonly RULE_nonReservedKeywords = 192;
    ...
    unloadStatement(): UnloadStatementContext;
    setStatement(): SetStatementContext;
    resetStatement(): ResetStatementContext;
    jarStatement(): JarStatementContext;
    ...
    windowTVFClause(): WindowTVFClauseContext;
    windowTVFExpression(): WindowTVFExpressionContext;
    windowTVFName(): WindowTVFNameContext;
    ...
    groupingSetsNotationName(): GroupingSetsNotationNameContext;
    ...
    orderItemDefinition(): OrderItemDefinitionContext;
...
export declare class SqlStatementContext extends antlr.ParserRuleContext {
    ...
    unloadStatement(): UnloadStatementContext | null;
    setStatement(): SetStatementContext | null;
    resetStatement(): ResetStatementContext | null;
    jarStatement(): JarStatementContext | null;
...
export declare class UnloadStatementContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class JarStatementContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class TableExpressionContext extends antlr.ParserRuleContext {
    ...
    windowTVFClause(): WindowTVFClauseContext | null;
    tableExpression(): TableExpressionContext[];
...
export declare class WindowTVFClauseContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    KW_TABLE(): antlr.TerminalNode;
    LR_BRACKET(): antlr.TerminalNode;
    windowTVFExpression(): WindowTVFExpressionContext;
...
export declare class WindowTVFExpressionContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    windowTVFName(): WindowTVFNameContext;
    LR_BRACKET(): antlr.TerminalNode;
    windowTVFParam(): WindowTVFParamContext[];
...
export declare class WindowTVFNameContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class GroupItemDefinitionContext extends antlr.ParserRuleContext {
    ...
    COMMA(): antlr.TerminalNode[];
    COMMA(i: number): antlr.TerminalNode | null;
    groupingSetsNotationName(): GroupingSetsNotationNameContext | null;
...
export declare class GroupingSetsNotationNameContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class MatchRecognizeClauseContext extends antlr.ParserRuleContext {
    ...
    patternDefinition(): PatternDefinitionContext | null;
...
export declare class OrderByClauseContext extends antlr.ParserRuleContext {
    ...
    KW_BY(): antlr.TerminalNode;
    orderItemDefinition(): OrderItemDefinitionContext[];
    orderItemDefinition(i: number): OrderItemDefinitionContext | null;
    COMMA(): antlr.TerminalNode[];
    COMMA(i: number): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: FlinkSqlParserListener): void;
...
export declare class OrderItemDefinitionContext extends antlr.ParserRuleContext {
...
export declare class PatternDefinitionContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class PatternVariablesDefinitionContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class ArithmeticBinaryContext extends ValueExpressionContext {
    ...
    PERCENT_SIGN(): antlr.TerminalNode | null;
    KW_DIV(): antlr.TerminalNode | null;
    ADD_SIGN(): antlr.TerminalNode | null;
    HYPHEN_SIGN(): antlr.TerminalNode | null;
...
export declare class MathOperatorContext extends antlr.ParserRuleContext {
    ...
    ADD_SIGN(): antlr.TerminalNode | null;
    HYPHEN_SIGN(): antlr.TerminalNode | null;
    DOUBLE_HYPHEN_SIGN(): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: FlinkSqlParserListener): void;
    exitRule(listener: FlinkSqlParserListener): void;
    accept<Result>(visitor: FlinkSqlParserVisitor<Result>): Result | null;
...
export declare class ReservedKeywordsUsedAsFuncNameContext extends antlr.ParserRuleContext {
    ...
    KW_JSON_EXISTS(): antlr.TerminalNode | null;
    KW_JSON_QUERY(): antlr.TerminalNode | null;
    KW_JSON_OBJECT(): antlr.TerminalNode | null;
    KW_JSON_OBJECTAGG(): antlr.TerminalNode | null;
    KW_JSON_ARRAY(): antlr.TerminalNode | null;
    KW_JSON_ARRAYAGG(): antlr.TerminalNode | null;
    get ruleIndex(): number;
    enterRule(listener: FlinkSqlParserListener): void;
    exitRule(listener: FlinkSqlParserListener): void;
    accept<Result>(visitor: FlinkSqlParserVisitor<Result>): Result | null;
