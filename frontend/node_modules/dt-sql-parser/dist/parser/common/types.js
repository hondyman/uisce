...
(function (EntityContextType) {
    ...
    EntityContextType["TABLE_PROPERTY_KEY"] = "tablePropertyKey";
    /** table property value when creating table*/
    EntityContextType["TABLE_PROPERTY_VALUE"] = "tablePropertyValue";
})(EntityContextType || (EntityContextType = {}));
export var SqlSplitStrategy;
(function (SqlSplitStrategy) {
    /** Only end the statement with semicolon symbol */
    SqlSplitStrategy[SqlSplitStrategy["STRICT"] = 0] = "STRICT";
    /** Based on parse tree to split statements */
    SqlSplitStrategy[SqlSplitStrategy["LOOSE"] = 1] = "LOOSE";
